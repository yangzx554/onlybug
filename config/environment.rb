...
#INDEXES="my_model shared"pluskid-rmmseg-cpp
...
Rails::Initializer.run do |config|
  ...
  # config.log_lrequire 'will_paginate'  evel = :debug
  ...
  config.action_controller.session = {
    :session_key => '_onlybug_session',
    :secret      => '86035eb951d933a2b7ee72d81d48d642'
  }
